...
export const Experience = () => {
  ...
  return (
    <section id="experience" className="py-16 px-4 bg-slate-800/30">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="space-y-8">
          {experiences.map((exp, index) => (
            <div
              key={index}
              className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 md:p-8 border border-slate-700 hover:border-blue-500/50 transition-all duration-300"
            >
