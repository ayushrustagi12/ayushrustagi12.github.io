...
export const Education = () => {
  ...
  return (
    <section
      id="education"
      className="py-16 px-4 bg-slate-800/30 relative overflow-hidden"
    >
      {/* Animated background */}
      <div className="absolute inset-0">
        <div className="absolute top-10 left-20 w-32 h-32 bg-purple-500/5 rounded-full blur-2xl animate-pulse"></div>
        <div
          className="absolute bottom-20 right-20 w-40 h-40 bg-blue-500/5 rounded-full blur-2xl animate-pulse"
