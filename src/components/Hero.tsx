      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-4 hover:scale-105 transition-transform duration-300">
            Ayush{" "}
            <span className="text-blue-400 bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
              Rustagi
            </span>
          </h1>
          ...
          <div className="h-8 mb-2">
            <p
              className={`text-xl md:text-2xl text-slate-300 transition-all duration-500 ${textIndex >= 0 ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-2"}`}
            >
              {titles[textIndex]}
            </p>
          </div>
          ...
          <p
            className="text-lg text-slate-400 mb-8 animate-fade-in"
        ...
        <div
          className={`bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 md:p-8 border border-slate-700 hover:border-blue-500/50 hover:bg-slate-800/70 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-blue-500/10 ${isVisible ? "animate-fade-in" : "opacity-0"}`}
        ...
        >
          ...
          <p className="text-slate-300 leading-relaxed hover:text-slate-200 transition-colors duration-300">
            ...
            <span className="text-purple-400 font-semibold">
              Laravel, ReactJS, and Python
            </span>
            . Sole-owned critical migration of{" "}
            <span className="text-green-400 font-semibold">90+ APIs</span> from
            Laravel to Python in 6 weeks, reducing response times by{" "}
            <span className="text-green-400 font-semibold">~40%</span>. Led
            cross-functional Agile teams with{" "}
            ...
            rate. AI-powered developer leveraging GitHub Copilot, ChatGPT, and
